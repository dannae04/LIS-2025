...
<nav class="navbar navbar-expand-lg fixed-top" style="background-color: #d7cfff;">
      ...
      <br><br><br><br><br>
       ...
       ?>
        ...
        <h1 class="text-center">TELAS DE NYLON</h1>
      <div class="cartas" style="margin: 5%;">
      <div class="row row-cols-1 row-cols-md-4 g-4">
      <?php foreach($productos as $producto) { 
       if (strpos(strtolower($producto['nombre']), 'nylon') !== false || strpos(strtolower($producto['descripcion']), 'nylon') !== false) { ?>
    <div class="col">
