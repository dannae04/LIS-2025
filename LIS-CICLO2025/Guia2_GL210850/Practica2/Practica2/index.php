            ...
            <table class="table table-bordered table-striped" style="margin-top:20px;">
                ...
                <tr>
                    ...
                    <td>
                      ...
                      <!--<a href="editar_modal.php" class="btn btn-success" data-toggle="modal"><span class="glyphicon glyphicon-plus"></span Editar</a>-->
                      <a href="editar_modal.php?codigo=<?= $materia->codigo?>"  class="btn btn-success">Editar</a>
