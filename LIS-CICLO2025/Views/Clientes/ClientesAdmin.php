    ...
    <table class="table table-hover align-middle bg-white">
        ...
        <tbody>
            ...
            <tr>
                ...
                <?php endif; ?>
                <td>
                <a href="<?= PATH ?>/Clientes/update/<?=$cliente['codigo_cliente']?>" class="btn btn-warning btn-sm">Editar</a>
                <a href="<?= PATH ?>/Clientes/delete/<?=$cliente['codigo_cliente']?>" class="btn btn-danger btn-sm">Eliminar</a>
                </td>
            </tr>
            <?php endforeach; ?>
        </tbody>
